import 'package:aoltask6/screen/authenticate/forgotpass.dart';
...
import 'package:aoltask6/screen/ProfileScreen.dart';
...
class UserDetails{
  ...
  UserDetails(this.providerDetails,this.userEmail,this.userName,this.userUID,this.providerData);
}
